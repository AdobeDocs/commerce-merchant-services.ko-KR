---
title: 일반 구성
description: '"사용할 수 있도록 일반 설정 구성 [!DNL Store Fulfillment] 내 가게에요 전역 확장 설정, 로깅, 데이터 동기화 및 보안을 위한 시스템 설정을 구성합니다. Adobe Commerce과 Store Fulfillment Services 간의 통합을 가능하게 하려면 주요 데이터를 제공하십시오."'
role: User, Admin
level: Intermediate
