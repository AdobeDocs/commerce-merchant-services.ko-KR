...
![새로 만들기](../assets/new.svg)<!-- Issue BOLT-520 --> 일반 공급 릴리스—[[!DNL Quick Checkout]](https://marketplace.magento.com/magento-quick-checkout.html) 이제 Adobe Commerce Cloud 버전 2.4.6 이상에서 사전 설치됩니다.
