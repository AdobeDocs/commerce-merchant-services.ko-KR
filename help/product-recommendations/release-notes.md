...
![신규](../assets/new.svg) 을(를) 도입했습니다. [`recommendations`](https://developer.adobe.com/commerce/webapi/graphql/schema/product-recommendations/queries/recommendations/) GraphQL API.
