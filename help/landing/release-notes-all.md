  ...
  <tbody>
    <tr>
      <td><strong>상거래 서비스</strong>
        <p>확장으로 사용할 수 있는 혁신적인 Commerce 서비스에 대한 최신 개선 사항에 대해 알아봅니다.</p>
          <ul>
      ...
      <td><strong>통합 서비스</strong>
        <p>Commerce Services에서 다른 서비스 및 Adobe 확장 및 제품과 연결할 수 있는 통합 서비스에 대한 최신 개선 사항에 대해 알아봅니다.</p>
          <ul>
      ...
      <td><strong>데이터 서비스</strong>
        <p>Commerce Services에서 제품 데이터를 관리할 수 있는 데이터 서비스의 최신 개선 사항에 대해 알아봅니다.</p>
          <ul>
