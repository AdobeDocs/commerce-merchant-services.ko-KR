...
![신규](../assets/new.svg)<!-- PAY-5047 --> 이제 상점 첫 화면의 고객 주문 페이지, 구매자에게 보낸 주문 확인 이메일 및 [주문 세부 사항 보기](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/order-management/orders/order-processing.html#view-an-order) Commerce 관리자
