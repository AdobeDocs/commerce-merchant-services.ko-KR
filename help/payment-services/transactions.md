...
1. 다음 항목 선택 _[!UICONTROL Card Type]_선택한 카드 유형에 대한 보고서 결과를 보려면 다음을 수행하십시오. 결제 프로세서가 카드 유형을 식별할 수 없는 경우 자세한 정보가 포함된 도구 설명이 표시됩니다.
1. 다음 항목 선택 _[!UICONTROL Card Brand]_선택한 카드 브랜드에 대한 보고서 결과를 봅니다. 결제 프로세서가 카드 브랜드를 식별할 수 없는 경우 자세한 정보가 포함된 도구 설명이 표시됩니다.
